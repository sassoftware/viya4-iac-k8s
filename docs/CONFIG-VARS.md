...
| kubernetes_version | Kubernetes version | string | "1.30.10" | Valid values are listed here: [Kubernetes Releases](https://kubernetes.io/releases/). |
...
| kubernetes_cni_version | Kubernetes Container Network Interface (CNI) Version | string | "3.32.1" | |
