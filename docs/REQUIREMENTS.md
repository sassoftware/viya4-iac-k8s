...
cluster_cni_version    = "3.32.1"                        # Kubernetes Container Network Interface (CNI) Version
...
kubernetes_cri_version     : "2.2.2"            # Choices : [2.2.2]
