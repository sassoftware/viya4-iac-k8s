...
cluster_cri_version    = "1.6.20"                        # Kubernetes Container Runtime Interface (CRI) Version, optionally set to an empty string for the latest version
...
kubernetes_cri_version     : "1.6.20"           # Optionally set to an empty string for the latest version
