...
| ~              | [kubectl](https://kubernetes.io/docs/tasks/tools/)                                                                                             | 1.33 - 1.36 |
...
If you are standing up your infrastructure via a Docker image created from the
[Dockerfile](../../docker/Dockerfile) overriding a dependency version can be
accomplished by supplying one or more docker build arguments:
