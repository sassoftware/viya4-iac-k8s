...
backing store may cause problems with the SAS Viya Software and its Information Catalog component. This
issue is known and is being addressed with [this issue](https://github.com/sassoftware/viya4-iac-k8s/issues/6). As soon as this is resolved this banner will be removed and documentation will be updated to direct you on how to active the correct storage class needed.
...
- At least 1 machine to host a PostgreSQL server (for the SAS Infrastructure Data Server component) if you are plan on using an external database server with your cluster
