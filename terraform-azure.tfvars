...
ssh_public_key   = "/r/narndhome01.unx.sas.com/vol/vol001/u01/ancgup/.ssh/id_rsa.pub"
...
prefix = "testk8s"
azure_resource_group = "testk8s-rg"
...
azure_default_public_access_cidrs = ["149.173.0.0/16", "194.206.69.176/28", "109.232.56.224/27", "62.255.11.0/29", "88.202.174.192/29", "137.221.139.0/24", "212.103.250.112/29", "88.151.216.240/29", "121.244.109.0/24", "125.21.192.0/29", "121.243.77.24/29", "106.120.85.32/28", "113.34.83.240/29", "192.31.22.0/24", "80.80.4.0/27"]
...
azure_subscription_id = "4a9d20ae-2cc3-4a23-8f54-995abbcfe1c7"
...
node_pools = {
  ...
  cas = {
    ...
    os_disk      = 100                # 100 GB OS disk
    data_disks   = [64]         # 2x512GB for memory spill
  ...
  generic = {
    ...
    os_disk      = 100                # 100 GB OS disk
    data_disks   = [64]              # 1x256GB for cache/temp data
    node_taints  = []
    node_labels = {
