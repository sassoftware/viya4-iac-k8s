# =============================================================================
# Sample tfvars for a SAS Viya 4 co-located topology on OpenStack (HPOS)
# using pre-assigned static IP addresses.
#
# Co-located topology: all Viya planes (Control, App, Data) share a single
# Kubernetes namespace. No tenant isolation is configured.
#
# Typical workflow:
...
# =============================================================================
# Split-Plane Topology — Co-located
#
# All Viya planes share one namespace. No tenant isolation.
# =============================================================================
split_plane_topology = "co_located"
viya_namespace       = "sas-viya"

# tenants is unused in co_located topology; leave as empty map
tenants = {}
