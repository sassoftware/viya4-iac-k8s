...
# Kubernetes - Cluster
cluster_version        = "1.34.7"       # Kubernetes Version
cluster_cni            = "calico"       # Kubernetes Container Network Interface (CNI)
cluster_cni_version    = "3.32.0"       # Kubernetes Container Network Interface (CNI) Version
cluster_cri            = "containerd"   # Kubernetes Container Runtime Interface (CRI)
cluster_cri_version    = "1.7.28"       # Kubernetes Container Runtime Interface (CRI) Version
