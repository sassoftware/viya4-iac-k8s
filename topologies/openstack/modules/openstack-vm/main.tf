...
locals {
  ...
  # Default cloud-init: disable SSH password auth (SSH key injection handled by Nova keypair).
  # To enable password auth or add local users, provide a custom user_data via the vm module.
