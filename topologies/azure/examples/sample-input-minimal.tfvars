...
# =============================================================================
# Azure Topology — Minimal Input Variables
# =============================================================================
# Minimal starter configuration — a small cluster suitable for evaluation or
# development deployments. Uses two node pools (control-plane + one generic
# worker pool) instead of per-workload dedicated pools.
#
# For a full production configuration with dedicated SAS Viya workload pools,
# see sample-input.tfvars instead.
#
...
#   terraform -chdir=topologies/azure plan  -var-file="examples/sample-input-minimal.tfvars"
#   terraform -chdir=topologies/azure apply -var-file="examples/sample-input-minimal.tfvars"
# =============================================================================
